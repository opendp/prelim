r"""
*From Meta's Opacus: https://github.com/pytorch/opacus/blob/f35653bdb5daabd2577ff2a2697706ebe45de9ca/opacus/accountants/analysis/rdp.py
*Mike Shoemate: From what I've read, I can (and should) drop the other Meta Apache license, 
                as this entire codebase is under MIT and Apache/MIT are compatible.
                Replicated here to facilitate comparisons.
